...
/**
 * Lexer rule to identify comments.
 *
...
public class Comments extends AbstractRule {
    ...
    protected Token applyRuleImplementation(
        ...
        // Type 1: a sequence of characters which starts with # and ends with a
        // newline.
        String match = matchWithRegex(currentSource, "^#[^\n]*");
        if (match != null)
            return new CommentToken(match, line, column, CommentType.TYPE_ONE);

        // Type2: begins with ‘{‘, continues with any character (including
        // end-of-line), and ends with ‘}’.
